...
<section id="propos">
    ...
    <div>
        ...
        <section id="profil" class="container">
            <section class="row">
                <section class="col-lg-3 col-xs-6 col-md-3 col-sm-6">
                    <img class="imgResize" src="../image/Chimay.png">
                    <p>Jacobs David</p>
                </section>
                <section class="col-lg-3 col-xs-6 col-md-3 col-sm-6">
                    <img class="imgResize" src="../image/guinness.jpg">
                    <p>Egan Lecocq</p>
                </section>
                <section class="col-lg-3 col-xs-6 col-md-3 col-sm-6">
                    <img class="imgResize" src="../image/tortuga.png">
                    <p>Luca Mellini</p>
                </section>
            </section>
            <section class="row">
                <section class="col-lg-3 col-xs-6 col-md-3 col-sm-6">
                    <img class="imgResize" src="../image/triple.jpg">
                    <p id="jordan">Jordan Vankeerberghen</p>
                </section>
                <section class="col-lg-3 col-xs-6 col-md-3 col-sm-6">
                    <img class="imgResize" src="../image/westmaell.png">
                    <p>Guillaume Wyart</p>
                </section>
                <section class="col-lg-3 col-xs-6 col-md-3 col-sm-6">
                    <img class="imgResize" src="../image/kidibul.jpg">
                    <p>Nicolas Rosar</p>
                </section>
            </section>
        </section>
    ...
    <div>
        <img class="imgResize" src="../image/iconFooter.png" id="logo">
        <p><b>Ephec Belgium</b>,<br>Avenue du Ciseau 15,<br>1348 Ottignies-Louvain-la-Neuve</p>
        <img class="imgResize" id="map" src="../image/map.PNG">
    </div>
</section>
</body>
</html>
