    ...
    public class RestService
    {
        ...
        public static async Task<List<T>> Request<T>(Dictionary<string, string> dic, string page)
        {
            ...
            try
            {
                ...
                HttpResponseMessage response = await client.PostAsync("https://theplacetobe.ovh/admin/" + page + ".php", content).ConfigureAwait(false);
        ...
        public static async void Request(Dictionary<string, string> dic, string page)
        {
            ...
            try
            {
                ...
                Dictionary<string, string> values = dic;
                FormUrlEncodedContent content = new FormUrlEncodedContent(values);
                await client.PostAsync("https://theplacetobe.ovh/admin/" + page + ".php", content).ConfigureAwait(false);
            }
            catch (Exception e)
            {
